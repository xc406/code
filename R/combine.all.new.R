...
motif.and.dnase.stat3.test2 <- read.delim("~/data/intersect_Irf41e3_fs_two_psorted", header=F)
...
k_r_network_stat3 <- res[["activation"]][["STAT3"]][["th17"]][,"C"] #knockout_rna_zscores.all[,"STAT3"]
...
#plot(stat3_aupr$rec, stat3_aupr$prec, type = 'lines', main = 'STAT3')
plot(stat3_aupr$rec, stat3_aupr$prec, type = 'lines', main = 'STAT3', xlab = 'recall', ylab = 'precision')
