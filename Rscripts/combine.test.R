## if you have a p-value from each time series HOW do you combine the multiple p-values OR scores
## into a single Pvalue to rank on ??
combine.test <- function(p, weight, method=c("fisher", "z.transform", "logit")) {
