...
def updateCount(path, db, motifChrom='chr17', window=100):
    ...
    for infile in glob.glob(os.path.join(path,"wgEncodeUwDnaseGm*_cut"+motifChrom)):
...
def updateFOS(path, db, motifChrom="chr17", dgfCutoff=40, method="Binom"):#, flankWin=35):
