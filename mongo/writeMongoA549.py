...
def getData(cursor, writer, window=0):
	...
	if not 'chip' in item:
		...
		item.get("cons").get("piSnp",'NA'),
                ...
                item["map"]["wgEncodeCrgMapabilityAlign36mer"],
                item["dgf"]["A549Aln"],#.values()[1],#["K562"],
		item.get("dgf").get("A549fos","NA"),
		item.get("dgf").get("A549fosStrand",'NA'),
		...
		#item["map"]["wgEncodeCrgMapabilityAlign36merchr17"],
		item["map"]["wgEncodeCrgMapabilityAlign36mer"],
		item["dgf"]["A549Aln"],#.values()[1],#["K562"],#["A549Aln"],
		item.get("dgf").get("A549fos","NA"),
		item.get("dgf").get("A549fosStrand","NA"),
		#item["dnase"]["Gm12878AlnRep1"]+item["dnase"]["Gm12878AlnRep1"],
		#item.get("dnase").get("fos","NA"),
