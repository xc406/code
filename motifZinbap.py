...
##gene names/ motif pval/ faireseq zinba sig 
##from intersected bed and zinba output files
...
def main(argv):
    ...
    ofile = open('/home/xc406/data/FAIRE_seq/' +  shortname + '_two', 'w')
    ...
    ifile2 = open('/home/xc406/data/FAIRE_seq/' +  shortname + '_two', 'r')
    reader2 = csv.reader(ifile2, delimiter = '\t')
    sortedlist = sorted(reader2, key = operator.itemgetter(0), reverse = False)
    
    ofile2 = open('/home/xc406/data/FAIRE_seq/' + shortname + '_two_psorted', 'w')
